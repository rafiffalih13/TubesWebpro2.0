	...
	<div class="container">
		<div class="row">
			...
			<div class="col-4 center">
				...
				<?php echo form_open('c_daftar/simpanPenjual');?>
				<form id="FormDaftar" action="<?php echo base_url(). 'index.php/c_daftar/simpanPenjual';?>">
					...
					<div class="form-group">
						<div class="col-sm-19">
							<input class="form-control" type="text" name="nama_penjual" id="nama_penjual" placeholder="Enter Full Name">
						</div>
					</div>
					<div class="form-group left">
						<div class="col-sm-19">
							<input class="form-control" type="text" name="nama_toko" id="nama_toko" placeholder="Enter Store Name">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-19">
